...
install_archive() {
    ...
    mkdir -p $dest
    cd $dest
    curl -sSL $archive | tar -x --strip-components 1 '*.el'
...
install_archive $dest emacs-lsp/lsp-mode 7.0.1
install_el $dest f rejeep/f.el v0.20.0
install_el $dest dash magnars/dash.el 2.17.0
install_el $dest dash-functional magnars/dash.el 2.17.0
install_el $dest ht Wilfred/ht.el 2.2
install_el $dest s magnars/s.el 1.12.0
install_el $dest spinner Malabarba/spinner.el 1.7.3
